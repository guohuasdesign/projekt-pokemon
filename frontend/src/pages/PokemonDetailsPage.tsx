        ...
        <div className="mx-auto max-w-5xl p-4 columns-2xl">
            ...
            <div className="grid md:grid-cols-5 gap-6">
                ...
                <div className="md:col-span-2 rounded-2xl bg-emerald-50 shadow p-4 flex items-center justify-center">
                    <img src={data.image} alt={data.name} className="w-4/5 max-w-sm object-contain" />
                </div>
                ...
                <div className="md:col-span-3">
                    <div className="flex items-center justify-between">
                        <h1 className="text-3xl font-bold capitalize">
                            {data.name} <span className="text-slate-400">#{padId(data.id)}</span>
                        </h1>
                        {!isInRoster ? (
                            <button
                    ...
                    <div className="mt-2 flex gap-2">{data.types.map(t => <TypeBadge key={t} type={t} />)}</div>
